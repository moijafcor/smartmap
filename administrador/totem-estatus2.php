<?php
/**
* @version    $Id: 'administrador/totem-estatus2.php' 29-07-2007 12:33:00 Moises Jafet$
  ...
  <div class="wrapper" align="center">
    <div id="core">
      ...
      <div id="cabezote" title="::Consola de Administraci&oacute;n [:DRmap(WebGUI):]::">
        ...
        <div id="Etiqueta">
          <h2>Editor de Estatus de la Implementaci&oacute;n de Proyectos</h2>
        </div>

        <div id="editor" class="forma<?php echo $pSufijo ?>" title="estatus de implementacion de proyecto">
          <!-- Forma Estatus Implementacion -->

          <form name="estatus-implementacion" action="demon-estatus2.php?id=<?php echo $editar ?>" method="post" id="estatus-implementacion">
            <fieldset>
              <legend>Estatus de la Implementaci&oacute;n</legend>

              <div class="col1form<?php echo $pSufijo ?>">
                <span class="etiqueta<?php echo $pSufijo ?>"><label>Nivel de Estatus (obligatorio):</label></span> <span class="colcampoformaob<?php echo $pSufijo ?>"><input type="text"
                name="nombre" size="39" value="<?php echo $nombre ?>" maxlength="150"></span>
              </div>
...
<?php echo $descripcion ?>
    ...
    var frmvalidator  = new Validator("estatus-implementacion");
