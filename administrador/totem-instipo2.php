<?php
/**
* @version    $Id: 'administrador/totem-instipo2.php' 05-08-2007 02:40:00 Moises Jafet$
  ...
  <div class="wrapper" align="center">
    <div id="core">
      ...
      <div id="cabezote" title="::Consola de Administraci&oacute;n [:DRmap(WebGUI):]::">
        ...
        <div id="Etiqueta">
          <h2>Editor de Tipo de Instituci&oacute;n Patrocinadora</h2>
        </div>

        <div id="editor" class="forma<?php echo $pSufijo ?>" title="Formulario Edicion Tipo de Instituci&oacute;n Patrocinadora">
          <!-- Forma Tipo de Institución Patrocinadora -->

          <form name="instipo" action="demon-instipo2.php?id=<?php echo $editar ?>" method="post" id="instipo">
            <fieldset>
...
<?php echo $descripcion ?>
    ...
    var frmvalidator  = new Validator("instipo");
