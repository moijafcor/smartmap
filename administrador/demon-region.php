<?php
/**
* @version     $Id: 'administrador/demon-region.php' 05-08-2007 03:00:00 Moises Jafet$
...
<head>
  ...
  <meta http-equiv="refresh" content="3; URL=index2.php?admin=region">
...
<body>
  <div class="wrapper" align="center">
    <div id="core">
      ...
      if (!$demon) {die ('Prohibido el accesso directo a este recurso');
      ...
      $db_tabla     =  $db_prefijo.$nombre_tabla;
          ...
          $sql="INSERT INTO `$db_tabla` ( `region` , `descripcion` )
          VALUES
          ('$_POST[region]','$_POST[descripcion]')";
