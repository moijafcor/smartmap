<?php
/**
* @version     $Id: 'administrador/demon-clas.php' 04-08-2007 22:37:00 Moises Jafet$
...
<head>
  ...
  <meta http-equiv="refresh" content="3; URL=index2.php?admin=clas">
  ...
  <div class="wrapper" align="center">
    <div id="core">
      ...
      $db_tabla     = $db_prefijo.$nombre_tabla;
          ...
          $sql="INSERT INTO `$db_tabla` ( `clasificacion` , `descripcion` )
          VALUES
              ('$_POST[clasificacion]','$_POST[descripcion]')";
