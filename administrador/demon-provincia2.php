<?php
/**
* @version    $Id: 'administrador/demon-provincia2.php' 07-08-2007 12:21:00 Moises Jafet$
...
<body>
  <div class="wrapper" align="center">
    <div id="core">
      ...
      `Provincia` = \''.$_POST['provincia'].'\', `Descripcion` = \''.$_POST['descripcion'].'\', `TotalPoblacion` = \''.$_POST['poblacion'].'\', `id_RegionGeografica` = \''.$_POST['region'].'\'
      WHERE `id` = \''.$_GET['id'].'\'
      LIMIT 1;';
