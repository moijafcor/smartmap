<?php
/**
* @version    $Id: 'administrador/totem-alcance2.php' 05-08-2007 01:59:00 Moises Jafet$
  ...
  <div class="wrapper" align="center">
    <div id="core">
      ...
      <div id="cabezote" title="::Consola de Administraci&oacute;n [:DRmap(WebGUI):]::">
        ...
        <div id="Etiqueta">
          <h2>Area de Alcance Geogr&aacute;fico</h2>
        </div>

        <div id="editor" class="forma<?php echo $pSufijo ?>" title="Formulario Ingreso Area de Alcance Geogr&aacute;fico">
          <!-- Forma Area de Alcance Geográfico -->

          <form name="alcance" action="demon-alcance2.php?id=<?php echo $editar ?>" method="post" id="alcance">
            <fieldset>
              <legend>Area de Alcance Geogr&aacute;fico</legend>

              <div class="col1form<?php echo $pSufijo ?>">
                <span class="etiqueta<?php echo $pSufijo ?>"><label>Alcance (obligatorio):</label></span> <span class="colcampoformaob<?php echo $pSufijo ?>"><input type="text" name=
...
<?php echo $descripcion ?>
    ...
    var frmvalidator  = new Validator("alcance");
