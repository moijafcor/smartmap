<?php
/**
* @version     $Id: 'administrador/demon-dist2.php' 05-08-2007 11:52:00 Moises Jafet$
...
<body>
  <div class="wrapper" align="center">
    <div id="core">
      ...
      `id_Tipos_Distribucion_Areas_EDom` = \''.$_POST['tipo'].'\', `id_Clasificacion_EDom` = \''.$_POST['clasificacion'].'\'
      WHERE `id` = \''.$_GET['id'].'\'
      LIMIT 1;';
