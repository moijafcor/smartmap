<?php
/**
* @version     $Id: 'administrador/totem-tipos.php' 04-08-2007 23:39:00 Moises Jafet$
...
?>
  <div id="Etiqueta" class="cabezote">
    <h2>Tipos de Areas de Distribuci&oacute;n (eDominicana)</h2><!-- Alternador de visibilidad del div de la forma -->
  ...
  <div id="ventana" style="display: none;" class="forma<?php echo $pSufijo ?>" title="Tipos de Areas de Distribucion">
    <!-- Forma Clasificación según eDominicana -->

    <form name="tipos-edom" action="demon-tipos.php?editar=tipos" method="post" id="tipos-edom">
      <fieldset>
        <legend>Tipos de Areas de Distribucion</legend>
...
frmvalidator.addValidation("nombre","req","El nombre es obligatorio");
  ...
  <div id='Tabla de resultados' title='Tabla de resultados'>
    ...
    <td class='tdlistased'>
        ...
        <form action='demon-tipos3.php' method='post'>
    ...
    <td class='tdlistased'>
        ...
        <form action='totem-tipos2.php' method='post'>
