<?php
/**
* @version    $Id: 'administrador/totem-blanco2.php' 05-08-2007 12:40:00 Moises Jafet$
  ...
  <div class="wrapper" align="center">
    <div id="core">
      ...
      <div id="cabezote" title="::Consola de Administraci&oacute;n [:DRmap(WebGUI):]::">
        ...
        <div id="Etiqueta">
          <h2>Editor de Tipos de P&uacute;blico Blanco Beneficiario</h2>
        </div>

        <div id="editor" class="forma<?php echo $pSufijo ?>" title="Formulario Edicion P&uacute;blico Blanco Beneficiario">
          <!-- Forma Tipos de Público Blanco Beneficiario -->

          <form name="blanco" action="demon-blanco2.php?id=<?php echo $editar ?>" method="post" id="blanco">
            <fieldset>
...
<?php echo $descripcion ?>
    ...
    var frmvalidator  = new Validator("blanco");
