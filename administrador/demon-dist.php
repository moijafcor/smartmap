<?php
/**
* @version     $Id: 'administrador/demon-dist.php' 05-08-2007 06:47:00 Moises Jafet$
...
<head>
  ...
  <meta http-equiv="refresh" content="3; URL=index2.php?admin=dist">
  ...
  <div class="wrapper" align="center">
    <div id="core">
      ...
      $db_tabla     =  $db_prefijo.$nombre_tabla;
          ...
          $sql = "INSERT INTO `$db_tabla` (id_Tipos_Distribucion_Areas_EDom , id_Clasificacion_EDom)
          VALUES
          ('$_POST[tipo]','$_POST[clasificacion]')";
