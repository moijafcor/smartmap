<?php
/**
* @version    $Id: 'administrador/demon-inst2.php' 07-08-2007 05:21:00 Moises Jafet$
...
<body>
  <div class="wrapper" align="center">
    <div id="core">
      ...
      `institucion` = \''.$_POST['institucion'].'\', `direccion` = \''.$_POST['direccion'].'\',
      `ciudad` = \''.$_POST['ciudad'].'\', `id_provincia` = \''.$_POST['provincia'].'\' ,
      `website` = \''.$_POST['website'].'\', `email` = \''.$_POST['Email'].'\' ,
      `telefono` = \''.$_POST['telefono'].'\', `id_Institu_Tipo` = \''.$_POST['instipo'].'\'
      WHERE `id` = \''.$_GET['id'].'\'
      LIMIT 1;';
