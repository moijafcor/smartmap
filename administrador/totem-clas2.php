<?php
/**
* @version    $Id: 'administrador/totem-clas2.php' 04-07-2007 23:13:00 Moises Jafet$
  ...
  <div class="wrapper" align="center">
    <div id="core">
      ...
      <div id="cabezote" title="::Consola de Administraci&oacute;n [:DRmap(WebGUI):]::">
        ...
        <div id="Etiqueta">
          <h2>Editor de Clasificaci&oacute;n seg&uacute;n eDominicana</h2>
        </div>

        <div id="editor" class="forma<?php echo $pSufijo ?>" title="Formulario Ingreso de Clasificaci&oacute;n seg&uacute;n eDominicana">
          <!-- Forma Estatus Implementacion -->

          <form name="clas-edom" action="demon-clas2.php?id=<?php echo $editar ?>" method="post" id="clas-edom">
            <fieldset>
              ...
              <div class="col1form<?php echo $pSufijo ?>">
                ...
                "clasificacion" size="39" value="<?php echo $clasificacion ?>" maxlength="150"></span>
              </div>
...
var frmvalidator  = new Validator("clas-edom");
