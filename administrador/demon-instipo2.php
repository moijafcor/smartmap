<?php
/**
* @version    $Id: 'administrador/demon-instipo2.php' 05-08-2007 02:43:00 Moises Jafet$
...
<head>
  ...
  <meta http-equiv="refresh" content="3; URL=index2.php?admin=instipo">
...
<body>
  <div class="wrapper" align="center">
    <div id="core">
      ...
      `instipo` = \''.$_POST['nombre'].'\', `descripcion` = \''.$_POST['descripcion'].'\'
      WHERE `id` = \''.$_GET['id'].'\'
      LIMIT 1;';
