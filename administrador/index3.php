      ...
      <div id="intro">
        <div id="icono" class="icono<?php echo $pSufijo ?>">
          ...
          switch ($icon)
                  ...
                  break;
                  case $dajabonIDtabla:
                  echo "<img src='../imagenes/dajabon_0.gif' width='55px' height='70px' alt='Provincia Dajabón' border='0'>";
                  break;
          /*      case $distritonacionalIDtabla:
                  ...
                  echo "<img src='../imagenes/eliaspina_0.gif' width='56px' height='75px' alt='Provincia Elias Piña' border='0'>";
                  break;
                  case $elseyboIDtabla:
                  ...
                  echo "<img src='../imagenes/mariatrinidadsanchez_0.gif' width='63px' height='70px' alt='Provincia María Trinidad Sánchez' border='0'>";
                  break;
                  case $monsnouelIDtabla:
                  echo "<img src='../imagenes/monsnouel_0.gif' width='61px' height='70px' alt='Monseñor Nouel' border='0'>";
                  break;
                  ...
                  break;
                  case $samanaIDtabla:
                  echo "<img src='../imagenes/samana_0.gif' width='70px' height='40px' alt='Provincia Samaná' border='0'>";
                  break;
                  case $sanchezramirezIDtabla:
                  echo "<img src='../imagenes/sanchezramirez_0.gif' width='70px' height='43px' alt='Provincia Sánchez Ramirez' border='0'>";
                  break;
                  case $sancristobalIDtabla:
                  echo "<img src='../imagenes/sancristobal_0.gif' width='43px' height='70px' alt='Provincia San Cristóbal' border='0'>";
                  break;
                  case $sanjoseocoaIDtabla:
                  echo "<img src='../imagenes/sanjoseocoa_0.gif' width='63px' height='69px' alt='San José de Ocoa' border='0'>";
                  break;
                  ...
                  echo "<img src='../imagenes/santiagorodriguez_0.gif' width='70px' height='68px' alt='Santiago Rodríguez' border='0'>";
                  break;
