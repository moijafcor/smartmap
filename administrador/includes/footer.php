<?php
/**
* @version     $Id: 'administrador/includes/footer.php' 04-08-2007 22:23:00 Moises Jafet$
...
*/
?><!-- //Puedes cambiar la declaracion de Copyright como desees. -->

  <div class="footer" align="center">
    &copy; Copyright <?php echo date("Y") ?> &nbsp; :: <a href="http://pro.moisesjafet.com/">Moises Jafet &reg; KK.MM Consulting Services ::</a>
  </div>
