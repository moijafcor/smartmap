<?php
/**
* @version     $Id: 'administrador/totem-alcance.php' 05-08-2007 01:20:00 Moises Jafet$
...
?>
  <div id="Etiqueta" class="cabezote">
    <h2>Area de Alcance Geogr&aacute;fico</h2><!-- Alternador de visibilidad del div de la forma -->
  ...
  <div id="ventana" style="display: none;" class="forma<?php echo $pSufijo ?>" title="Area de Alcance Geogr&aacute;fico">
    <!-- Forma Clasificación según eDominicana -->

    <form name="alcance" action="demon-alcance.php?editar=alcance" method="post" id="alcance">
      <fieldset>
        <legend>Area de Alcance Geogr&aacute;fico</legend>

        <div class="col1form<?php echo $pSufijo ?>">
          <span class="etiqueta<?php echo $pSufijo ?>"<label>Alcance (obligatorio):</label></span> <span class="colcampoformaob<?php echo $pSufijo ?>"><input type="text" name="nombre"
...
frmvalidator.addValidation("nombre","req","El nombre es obligatorio");
  ...
  <div id='Tabla de resultados' title='Tabla de resultados'>
    ...
    echo "<tr class='etiqueta'><th class='thlistasiz'>Admin</th><th class='thlistasiz'></th>
        <th class='thlistasiz'>Id</th><th class='thlistasce'>Alcance</th>
    ...
    <td class='tdlistased'>
        ...
        <form action='demon-alcance3.php' method='post'>
    ...
    <td class='tdlistased'>
        ...
        <form action='totem-alcance2.php' method='post'>
