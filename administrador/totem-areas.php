<?php
/**
* @version     $Id: 'administrador/totem-areas.php' 04-08-2007 03:10:00 Moises Jafet$
...
?>
  ...
  <div id="Etiqueta" class="cabezote">
    <h2>Areas de Desarrollo (Clasificaci&oacute;n del Indotel)</h2><!-- Alternador de visibilidad del div de la forma -->
  ...
  <div id="ventana" style="display: none;" class="forma<?php echo $pSufijo ?>" title="Areas de Desarrollo seg&uacute;n Indotel">
    <!-- Forma Areas de Desarrollo según Indotel -->

    <form name="areas" action="demon-areas.php?editar=areas" method="post" id="areas">
      <fieldset>
        <legend>Areas de Desarrollo (Clasificaci&oacute;n del Indotel)</legend>

        <div class="col1form<?php echo $pSufijo ?>">
          <span class="etiqueta<?php echo $pSufijo ?>"><label>Nombre (obligatorio):</label></span> <span class="colcampoformaob<?php echo $pSufijo ?>"><input type="text" name="nombre"
...
var frmvalidator  =
  ...
  <div id='Tabla de resultados' title='Tabla de resultados'>
    ...
    <td class='tdlistased'>
        ...
        <form action='demon-areas3.php' method='post'>
    ...
    <td class='tdlistased'>
        ...
        <form action='totem-areas2.php' method='post'>
