<?php
/**
* @version     $Id: 'administrador/demon-provincia.php' 06-08-2007 04:00:00 Moises Jafet$
...
<head>
  ...
  <meta http-equiv="refresh" content="3; URL=index2.php?admin=provincia">
  ...
  <div class="wrapper" align="center">
    <div id="core">
      ...
      $db_tabla     = $db_prefijo.$nombre_tabla;
          ...
          $sql="INSERT INTO `$db_tabla` ( `Provincia` , `Descripcion`,`TotalPoblacion` , `id_RegionGeografica` )
          VALUES
          ('$_POST[provincia]','$_POST[descripcion]','$_POST[poblacion]','$_POST[region]')";
