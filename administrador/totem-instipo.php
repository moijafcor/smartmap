<?php
/**
* @version     $Id: 'administrador/totem-instipo.php' 04-08-2007 02:34:00 Moises Jafet$
...
?>
  ...
  <div id="Etiqueta" class="cabezote">
    <h2>Tipo de Instituci&oacute;n Patrocinadora</h2><!-- Alternador de visibilidad del div de la forma -->
  ...
  <div id="ventana" style="display: none;" class="forma<?php echo $pSufijo ?>" title="Tipo de Instituci&oacute;n Patrocinadora">
    <!-- Forma Público Blanco Beneficiario -->

    <form name="instipo" action="demon-instipo.php?editar=instipo" method="post" id="instipo">
      <fieldset>
        <legend>Tipo de Instituci&oacute;n Patrocinadora</legend>
...
frmvalidator.addValidation("nombre","req","El nombre es obligatorio");
  ...
  <div id='Tabla de resultados' title='Tabla de resultados'>
    ...
    $marcadorb = "$mosConfig_live_site/$carp/administrador/demon-instipo3.php?borrar=";
    ...
    <td class='tdlistased'>
        ...
        <form action='demon-instipo3.php' method='post'>
    ...
    <td class='tdlistased'>
        ...
        <form action='totem-instipo2.php' method='post'>
